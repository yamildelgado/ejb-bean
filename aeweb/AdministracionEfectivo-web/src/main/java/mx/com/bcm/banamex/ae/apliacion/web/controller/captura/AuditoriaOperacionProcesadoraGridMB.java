...
import net.sf.jasperreports.engine.JRException;
	 ...
	 */
@ManagedBean(name = "audiOperProcGridMB")
@RequestScoped	
public class AuditoriaOperacionProcesadoraGridMB {
	...
	private List<TipoOperacionesProcesadoraVO> listaOperacionesVO;
	...
	public String fechaActual(){
        ...
        setFechaAuditoria(dia + "/" + (mes+1) + "/" + anio);
        
		return getFechaAuditoria();
	}
public void generarRepore() throws JRException, IOException{
...
private String getFechaAuditoria() {
	return fechaAuditoria;
}


private void setFechaAuditoria(String fechaAuditoria) {
